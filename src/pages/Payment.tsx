...
const RAZORPAY_KEY_ID =
  import.meta.env.VITE_RAZORPAY_KEY_ID || "rzp_test_E9RUW3lWWFhhM7";
const API_BASE_URL =
  import.meta.env.VITE_API_URL ||
  "https://vhdev.onrender.com/api/payments/%7B%7Bpayment_id%7D%7D/status";
      ...
      <div className="bg-white rounded-xl p-8 max-w-md w-mx-4 text-center">
        <div className="mb-6">
          <div className="relative overflow-hidden h-20 mb-4">
            ...
            <div
              className="absolute bottom-6 right-4 animate-bounce"
...
const Payment: React.FC = () => {
  ...
  // Handle Razorpay payment for all methods except COD
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/create-cod-order/`, {
        ...
        body: JSON.stringify({
          ...
          payment_method: "cod",
          total_amount: getCartTotal() + 50, // Including COD charges
        }),
      });
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-700">
                  Your card payment will be processed securely through Razorpay.
        ...
        return (
          <div className="bg-blue-50 p-4 rounded-lg">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-700">
                  Pay using UPI through Razorpay. You can use any UPI app like
                  GPay, PhonePe, Paytm, or BHIM UPI.
                </p>
              </div>
            </div>
          </div>
        ...
        return (
          <div className="bg-blue-50 p-4 rounded-lg">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-700">
                  You will be redirected to Razorpay to select your bank and
                  complete the payment securely through internet banking.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    Please keep exact change ready. Additional charges of ₹50
  ...
  return (
    <div className="min-h-screen bg-[#F9F7F5]">
      <Navbar />
      {showCarAnimation && (
        <CarAnimation onComplete={handleAnimationComplete} />
      )}
              ...
              <div className="border-t border-gray-200 mt-6 pt-6">
                ...
                <div className="flex justify-between text-lg font-bold text-gray-900 mt-2">
                  ...
                  <p>
                    ₹
                    {(
                      getCartTotal() + (paymentMethod === "cod" ? 50 : 0)
                    ).toFixed(2)}
                  </p>
                </div>
              </div>
